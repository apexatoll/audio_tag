RSpec.describe AudioTag::ID3::V2::Frame do
  ...
  before { stub_const "AudioTag::ID3::V2::FrameType::LOOKUP", {} }
  ...
  describe "#header" do
    ...
    it "returns a frame header" do
      expect(header).to be_an(AudioTag::ID3::V2::FrameHeader)
    end
  ...
  describe ".build" do
    ...
    before do
      stub_const "AudioTag::ID3::V2::FrameType::LOOKUP", lookup
    end
