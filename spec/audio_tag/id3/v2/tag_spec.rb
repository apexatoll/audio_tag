RSpec.describe AudioTag::ID3::V2::Tag do
  ...
  before do
    stub_const "AudioTag::ID3::V2::FrameType::LOOKUP", {}
  end
  ...
  describe "#header" do
    ...
    it "returns a tag header" do
      expect(header).to be_an(AudioTag::ID3::V2::TagHeader)
    end
  ...
  describe "#frames" do
    ...
    it "returns an array of frames" do
      expect(frames).to all be_an(AudioTag::ID3::V2::Frame)
    end
  ...
  describe "#to_h" do
    ...
    before do
      allow(AudioTag::ID3::V2::FrameMerger)
        .to receive(:new)
        .and_return(frame_merger)
    end

    let(:frame_merger) do
      instance_spy(AudioTag::ID3::V2::FrameMerger, merge: merged)
    end
    ...
    it "instantiates a frame merger" do
      ...
      expect(AudioTag::ID3::V2::FrameMerger)
