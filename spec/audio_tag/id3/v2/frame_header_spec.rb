RSpec.describe AudioTag::ID3::V2::FrameHeader do
  ...
  let(:frame_class) do
    Class.new(AudioTag::ID3::V2::Frame)
  end

  let(:frame_type) do
    AudioTag::ID3::V2::FrameType.new(name:, frame_class:)
  end

  before do
    allow(AudioTag::ID3::V2::FrameType)
      .to receive(:find)
      .with(:TALB)
